...
_PROVIDERS: tuple[ProviderSpec, ...] = (
    ...
    ProviderSpec(
        ...
        probe_models=("glm-5.3", "glm-4.7", "glm-4.6", "glm-4.5"),
        default_model="glm-5.3",
        aliases=("zai", "z-ai", "glm", "zhipu"),
        models=("glm-5.3", "glm-5.3-flash", "glm-4.7", "glm-4.6", "glm-4.5", "glm-4.5-air"),
        notes="GLM coding plan; Anthropic-compatible endpoint drives claude-code.",
        alt_token_envs=("ZAI_CODING_API_KEY", "ZHIPU_API_KEY"),
    ),
    ProviderSpec(
        id="deepseek",
        label="DeepSeek",
